...
export default function HomePage() {
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed top-0 left-1/4 w-96 h-96 bg-hero-purple/10 rounded-full blur-3xl pointer-events-none" />
      <div className="fixed bottom-1/4 right-1/4 w-64 h-64 bg-hero-cyan/8 rounded-full blur-3xl pointer-events-none" />
