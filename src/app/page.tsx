...
import { ArrowRight, Shield, Users, Swords, Zap, Crown } from 'lucide-react'
...
export default function HomePage() {
  ...
  const statCards = [
    ...
    { icon: Crown,  label: 'Ranks Available',      value: stats.ranks.toString(), color: 'text-gold-mid' },
    { icon: Zap,    label: 'Uptime',               value: stats.uptime, color: 'text-hero-green' },
  ]
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        {/* Subtle grid */}
        <div className="absolute inset-0 bg-grid-pattern opacity-100" style={{ backgroundSize: '50px 50px' }} />
      </div>
      ...
      <section className="relative pt-32 pb-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          {/* Tagline */}
          <p className="text-xl md:text-2xl text-slate-400 max-w-2xl mx-auto mb-4 font-light leading-relaxed animate-fade-in">
            The Ultimate Minecraft Survival Experience.
          </p>
          <p className="text-base text-slate-500 max-w-xl mx-auto mb-12 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20 animate-fade-in">
            ...
            <a href="minecraft://play.herossmp.xyz"
              ...
              style={{ fontFamily: 'var(--font-display)' }}>
              <Swords className="w-5 h-5 text-gold-mid" />
              Join Server
            </a>
          </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="glass-gold rounded-2xl px-6 py-4 flex items-center justify-between gap-4 flex-wrap">
            <div className="flex items-center gap-3">
              ...
              <code className="text-gold-mid font-mono font-bold text-sm tracking-wider">play.herossmp.xyz</code>
            </div>
            <a href="minecraft://play.herossmp.xyz"
      ...
      <section className="relative px-4 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="font-display text-xl font-bold text-gold-mid tracking-widest uppercase">Live Arena</h2>
            <div className="divider-gold flex-1" />
          </div>
